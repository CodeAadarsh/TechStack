...
- [Markdown Table](https://tableconvert.com/html-to-markdown?data=http://localhost:4000/resolutions#TableGenerator)
- [Template](https://tableconvert.com/html-to-template?data=http://localhost:4000/resolutions#TableGenerator)
- [LaTeX Table](https://tableconvert.com/html-to-latex?data=http://localhost:4000/resolutions#TableGenerator)
- [CSV](https://tableconvert.com/html-to-csv?data=http://localhost:4000/resolutions#TableGenerator)
- [Excel](https://tableconvert.com/html-to-excel?data=http://localhost:4000/resolutions#TableGenerator)
- [JSON Array](https://tableconvert.com/html-to-json?data=http://localhost:4000/resolutions#TableGenerator)
- [HTML Table](https://tableconvert.com/html-to-html?data=http://localhost:4000/resolutions#TableGenerator)
- [Insert SQL](https://tableconvert.com/html-to-sql?data=http://localhost:4000/resolutions#TableGenerator)
- [YAML Sequence](https://tableconvert.com/html-to-yaml?data=http://localhost:4000/resolutions#TableGenerator)
- [XML](https://tableconvert.com/html-to-xml?data=http://localhost:4000/resolutions#TableGenerator)
- [ASCII](https://tableconvert.com/html-to-ascii?data=http://localhost:4000/resolutions#TableGenerator)
- [MediaWiki Table](https://tableconvert.com/html-to-mediawiki?data=http://localhost:4000/resolutions#TableGenerator)
- [AsciiDoc Table](https://tableconvert.com/html-to-asciidoc?data=http://localhost:4000/resolutions#TableGenerator)
- [Jira Table](https://tableconvert.com/html-to-jira?data=http://localhost:4000/resolutions#TableGenerator)
- [Textile Table](https://tableconvert.com/html-to-textile?data=http://localhost:4000/resolutions#TableGenerator)
- [reStructuredText](https://tableconvert.com/html-to-restructuredtext?data=http://localhost:4000/resolutions#TableGenerator)
- [PHP Array](https://tableconvert.com/html-to-php?data=http://localhost:4000/resolutions#TableGenerator)
- [Ruby Array](https://tableconvert.com/html-to-ruby?data=http://localhost:4000/resolutions#TableGenerator)
- [ASP Array](https://tableconvert.com/html-to-asp?data=http://localhost:4000/resolutions#TableGenerator)
- [ActionScript](https://tableconvert.com/html-to-actionscript?data=http://localhost:4000/resolutions#TableGenerator)
- [BBCode](https://tableconvert.com/html-to-bbcode?data=http://localhost:4000/resolutions#TableGenerator)
- [PDF](https://tableconvert.com/html-to-pdf?data=http://localhost:4000/resolutions#TableGenerator)
- [JPEG](https://tableconvert.com/html-to-jpeg?data=http://localhost:4000/resolutions#TableGenerator)
{.cols-4 .marker-none}
