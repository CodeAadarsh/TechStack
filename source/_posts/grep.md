...
background: hover:scale-110 duration-500  bg-emerald-400
tags: 
    - egrep
    - search
    - pattern
...
| `-r`   | grep -r 'TechStacks' /var/log/nginx/ | Recursive search _(within subdirs)_                  |
...
### Refer
- [Regex syntax](/regex) _(TechStacks)_
- [Regex examples](/regex#regex-examples) _(TechStacks)_
