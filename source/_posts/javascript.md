...
background: hover:scale-110 duration-500  bg-[#ebd94e]
tags:
    - js
    - web
categories:
...
- [JSON cheatsheet](/json) _(TechStacks)_
- [Regex in JavaScript](/regex#regex-in-javascript) _(TechStacks)_
...
// => Hello TechStacks
console.warn('hello %s', 'TechStacks');
