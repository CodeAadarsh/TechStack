...
background: hover:scale-110 duration-500  bg-[#cc5534]
tags:
    - web
categories:
    - Programming
...
<body>
    <h1>Hello world, hello TechStacks!</h1>
</body>
</html>
```
...
```html 
<a href="http://localhost:4000">CheatSheets</a>
...
### HTML5 mark
```html
<p>I Love <mark>TechStacks</mark></p>
```
<p>I Love <mark>TechStacks</mark></p>
...
<meta property="og:url" content="http://localhost:4000/html">
...
<meta name="twitter:url" content="TechStackshtml">
