...
background: hover:scale-110 duration-500  bg-[#e56d2d]
tags:
    - regular expression
    - regexp
    - pattern
...
- [Regex in Python](#regex-in-python) _(TechStacks)_
- [Regex in JavaScript](#regex-in-javascript) _(TechStacks)_
- [Regex in PHP](#regex-in-php) _(TechStacks)_
- [Regex in Java](#regex-in-java) _(TechStacks)_
- [Regex in MySQL](#regex-in-mysql) _(TechStacks)_
- [Regex in Vim](/vim#search-and-replace) _(TechStacks)_
- [Regex in Emacs](/emacs#search) _(TechStacks)_
