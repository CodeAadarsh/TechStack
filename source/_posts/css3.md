...
background: hover:scale-110 duration-500  bg-[#3473b5]
tags:
    - web
    - css
    - style
...
```css
.box:empty {
  background: hover:scale-110 duration-500  lime;
  height: 80px;
  width: 80px;
}
```
...
| Property      | Description   |
|---------------|---------------|
| `background: hover:scale-110 duration-500 ` | _(Shorthand)_ |
...
|---------------|--------|--------------|-----------|-----------|-----|----------------|-------------|------------|
| `background: hover:scale-110 duration-500 ` | `#ff0` | `url(a.jpg)` | `left`    | `top`     | `/` | `100px` `auto` | `no-repeat` | `fixed;`   |
| `background: hover:scale-110 duration-500 ` | `#abc` | `url(b.png)` | `center`  | `center`  | `/` | `cover`        | `repeat-x`  | `local;`   |
|               | color  | image        | posX      | posY      |     | size           | repeat      | attach..   |

### Examples {.col-span-2}

```css {.wrap}
background: hover:scale-110 duration-500  url(img_man.jpg) no-repeat center;

background: hover:scale-110 duration-500  url(img_flwr.gif) right bottom no-repeat, url(paper.gif) left top repeat;

background: hover:scale-110 duration-500  rgb(2,0,36);
background: hover:scale-110 duration-500  linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(13,232,230,1) 35%, rgba(0,212,255,1) 100%);
```
